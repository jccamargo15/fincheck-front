    ...
    <div>
      <div className="relative">
        ...
        <RdxSelect.Root onValueChange={handleSelect}>
          <RdxSelect.Trigger
            className={cn(
              'px-3 border border-gray-500 bg-white rounded-lg h-[52px] text-gray-800 w-full focus:border-gray-800 transition-all outline-none text-left relative pt-4',
          ...
          <RdxSelect.Portal>
            <RdxSelect.Content
              className="z-[99] overflow-hidden bg-white rounded-2xl border border-gray-100 shadow-[Opx_11px_20px_0px_rgba(0,0,0,0.10)]"
            >
              ...
              <RdxSelect.Viewport className="p-2">
                {options.map((option) => (
                  <RdxSelect.Item
                    key={option.value}
                    value={option.value}
                    className="p-2 textgray-800 text-sm data-[state=checked]:font-bold outline-none data-[highlighted]:bg-gray-50 rounded-lg transition-colors"
                  >

  ...
  return (
    <div className="relative">
      <input
        ...
        name={name}
        id={inputId}
        className="px-3 border border-gray-500 bg-white rounded-lg h-[52px] text-gray-800 w-full pt-4 peer placeholder-shown:pt-0 focus:border-gray-800 transition-all outline-none"
        placeholder=" "
      />
